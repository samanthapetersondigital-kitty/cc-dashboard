// ============================================================
// Carmela Conroy Dashboard — App.jsx
...
const DATA = {
  ...
  finances: {
    totalRaised: 85813.72,
    emailDigital: 27948.0,
    smsDigital: 0.0,
    digitalTarget: 0.10,
    byMonth: [
      { month: "2025-11", total: 6696.0, digital: 2750.0 },
      { month: "2025-12", total: 17620.0, digital: 7838.0 },
      { month: "2026-01", total: 14110.0, digital: 4204.0 },
      { month: "2026-02", total: 22744.2, digital: 4190.0 },
      { month: "2026-03", total: 19524.26, digital: 8082.0 },
      { month: "2026-04", total: 5119.26, digital: 884.0 }
    ],
  },

  texting: {
    campaigns: [
      { name: "CC_EOQ FR_260331", date: "3/31/26", delivered: 5219, clicked: 117, revenue: 0 }
    ],
    costPerMsg: 0.07,
  },
  ...
  return (
    <div style={{ fontFamily:"Arial,sans-serif", maxWidth:1100, margin:"0 auto", padding:20 }}>
      <h1 style={{ background:"#1F4E79", color:"#fff", padding:"12px 20px", borderRadius:6, marginBottom:16 }}>
        Carmela Conroy — Digital Dashboard ({DATA.period})
      </h1>
